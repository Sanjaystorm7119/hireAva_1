...
function InterviewCard({ interview, viewDetail = false }) {
  ...
  return (
    <CardContainer className="inter-var  ">
      ...
      <CardBody className="bg-gray-50  relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] sm:w-[20rem] h-auto rounded-xl p-4 border  ">
        <CardItem
          translateZ="50"
